...
export const getMessages = createAction<actionTypes.TGetMessages>(actionTypes.GET_MESSAGES);
...
export const setPage = createAction<actionTypes.TSetPage>(actionTypes.SET_PAGE);
export const setDataBeforeLoad = createAction(actionTypes.SET_DATA_BEFORE_LOAD);
